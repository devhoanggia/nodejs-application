...
Your task is to create a Nodejs application that is a feeds reader. The app can read feed from multiple feeds and store them to database. Sample feeds http://www.feedforall.com/sample-feeds.htm.

## Requirements
- The application must be developed by using a nodejs framework and follow coding standard of that framework.
